...
@section('content')
@include('Category.Edit.pages.Add-SubCategory.edit')
<div class="row p-3">
        ...
        <div class="card-body">
            <div class="row">
                <div class="col-lg-6">
                    ...
                    <label class="col-form-label">SubCategory Title* EN</label>
                ...
                <div class="col-lg-6">
                    <label class="col-form-label">SubCategory Title* AR</label>
