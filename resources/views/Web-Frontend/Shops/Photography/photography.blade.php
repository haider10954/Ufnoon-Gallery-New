...
<div class="ws-breadcrumb">
    <div class="container">
        <ol class="breadcrumb">
            ...
            <li class="active">{{ __('translation.Photography') }} (2)</li>
        </ol>
    </div>
</div>
<!-- End Breadcrumb -->
...
<section class="ws-arrivals-section">
    ...
    <div class="ws-works-title clearfix">
        <div class="col-sm-12">
            <h3>{{ __('translation.All Photography')}}</h3>
                    ...
                    <div role="tabpanel" class="tab-pane fade in active" id="artist1">
                        ...
                        <div class="col-sm-6 col-md-4 ws-works-item">
                            <a href="#">
                                <!-- Image -->
                                <figure>
                                    <img src="{{ asset('web-assets/img/works/photography/photography1.jpg') }}" alt="Alternative Text" class="img-responsive" width="900" height="1000">
                                </figure>
                        ...
                        <div class="col-sm-6 col-md-4 ws-works-item">
                            <a href="#">
                                <!-- Image -->
                                <figure>
                                    <img src="{{ asset('web-assets/img/works/photography/photography2.jpg') }}" alt="Alternative Text" class="img-responsive" width="900" height="1000">
                                </figure>
                                <div class="ws-works-caption text-center">
                                    <!-- Item Category -->
