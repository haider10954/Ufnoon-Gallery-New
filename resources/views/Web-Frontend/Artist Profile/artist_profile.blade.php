...
@section('content')
<!-- <div class="container-fluid bg-white" style="box-shadow: 2px 2px 2px 2px;">
    <div class="row">
        <div class="col-sm-3 col-md-4 col-lg-3" style="margin-top: 10px; margin-bottom:10px;">
            <div class="text-center">
                <img src="{{ asset('web-assets/img/works/Artists/artist1.jpeg')}}" style="height: 200xp; width: 200px;">
            </div>
        </div>
        <div class="col-sm-3 col-md-4 col-lg-9" style="margin-top: 10px;">
            <h1 >Artist Name</h1> <br>
            <h3 > Artist Category</h3> <br>
            <div class="d-flex">
                <h6><i class="fa fa-instagram"><span style="margin-left: 10px;">user name</span></i></h6>
                <h6 style="margin-left: 10px;"><i class="fa fa-twitter"><span style="margin-left: 10px;">Twitter user name</span></i></h6>
            </div>
        </div>
    </div>
</div>
...
<div class="container-fluid bg-white" style="box-shadow: 2px 2px 2px 2px;">
    <div class="row">
        <div class="col-sm-3 col-md-4 col-lg-4" style="margin-top: 10px; margin-bottom:10px;">
            <div class="text-center">
                <i class="fa fa-image"><span style="margin-left:10px">Artworks</span></i>
                <p class="text-muted">The number of artworks 0</p>
            </div>
        </div>
        <div class="col-sm-3 col-md-4 col-lg-4" style="margin-top: 10px; margin-bottom:10px;">
            <div class="text-center">
                <i class="fa fa-image"><span style="margin-left:10px">Exhibitions</span></i>
                <p class="text-muted">The number of Exhibitions 0</p>
            </div>
        </div>
        <div class="col-sm-3 col-md-4 col-lg-4" style="margin-top: 10px; margin-bottom:10px;">
            <div class="text-center">
                <i class="fa fa-cart"><span style="margin-left:10px">Orders</span></i>
                <p class="text-muted">The number of Orders 0</p>
            </div>
        </div>
    </div>
</div> -->
            ...
            <div class="card">
                ...
                <div class="card-text">
                    ...
                    <div class="title-total">
                        <div class="title">Featured Artist</div>
                        <h2>Artist Name</h2>

                        <div class="desc">Lorem ipsum dolor sit amet consectetur adipisicing elit. Eius autem provident a voluptatem iste. Ab nobis cumque mollitia dicta. Debitis, voluptas expedita veritatis molestias dolore sunt eos explicabo quam rem!</div>
                        <div class="actions">
