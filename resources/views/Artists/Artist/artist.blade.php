            ...
            <div class="card-body">
                <div class="row align-items-center">
                    ...
                    <div class="col-md-6 col-lg-6 mb-3" style="text-align: right;">
                        <a class="btn px-5 btn-primary round-s" href="{{ route('add_artist')}}">
                ...
                <table id="datatable-buttons" class="table table-striped table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td><img src="{{ asset('assets/images/users/avatar-1.jpg')}}" style="height: 50px; width:50px;" /></td>
                            <td>أثير الشلقان</td>
                            <td>Featured Artists</td>
                            <td>a-moof33@hotmail.com</td>
                            <td><button class="btn-sm btn btn-success">Yes</button></td>
                            <td>No of Views 2</td>
                            <td>Active</td>
